...
def sample_newsletter() -> Newsletter:
    ...
    news = NewsBlocks(
        us="Введите новости по региону США здесь. Каждый абзац — с новой строки.",
        europe="Введите новости по Европе здесь.",
        asia="Введите новости по Азии здесь.",
        cis="Введите новости по СНГ здесь.",
        capital_markets=["«Алокабанк» завершил 2025 год с убытком по МСФО ..."],
    )
